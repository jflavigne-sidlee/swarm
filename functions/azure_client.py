...
class Messages:
    ...
    def list(self,
             ...
             before: Optional[str] = DEFAULT_MESSAGE_BEFORE) -> Any:
...
class Runs:
    ...
    def list(self, 
             ...
             before: Optional[str] = DEFAULT_RUN_BEFORE) -> Any:
    ...
    def submit_tool_outputs(self, 
                          ...
                          stream: Optional[bool] = DEFAULT_STREAM) -> Any:
...
class Threads:
    ...
    def list(self,
             ...
             before: Optional[str] = DEFAULT_THREAD_BEFORE) -> Any:
        """Lists threads"""
        if limit and limit not in LIST_LIMIT_RANGE:
            raise ValueError(ERROR_INVALID_LIMIT)
...
class Chat:
    ...
    class Completions:
        ...
        def create(self, 
                  ...
                  parallel_tool_calls: Optional[bool] = DEFAULT_PARALLEL_TOOL_CALLS) -> Any:
...
class AzureClientWrapper:
    ...
    def create_assistant(self, 
                        ...
                        tool_resources: Optional[Dict[str, Any]] = DEFAULT_TOOL_RESOURCES) -> Any:
    ...
    def create_thread(self,
                     ...
                     tool_resources: Optional[Dict[str, Any]] = DEFAULT_THREAD_TOOL_RESOURCES) -> Any:
        """Creates a thread."""
        ...
        if tool_resources:
            if THREAD_TOOL_TYPE_CODE_INTERPRETER in tool_resources:
                file_ids = tool_resources[THREAD_TOOL_TYPE_CODE_INTERPRETER].get("file_ids", [])
            ...
            if THREAD_TOOL_TYPE_FILE_SEARCH in tool_resources:
                vector_store_ids = tool_resources[THREAD_TOOL_TYPE_FILE_SEARCH].get("vector_store_ids", [])
                vector_stores = tool_resources[THREAD_TOOL_TYPE_FILE_SEARCH].get("vector_stores", [])
                if len(vector_store_ids) + len(vector_stores) > MAX_THREAD_FILE_SEARCH_STORES:
    ...
    def create_run(self,
                  ...
                  additional_messages: Optional[List[Dict[str, Any]]] = DEFAULT_ADDITIONAL_MESSAGES,
                  ...
                  response_format: Optional[Dict[str, str]] = DEFAULT_RUN_RESPONSE_FORMAT) -> Any:
    ...
    def list_runs(self,
                 ...
                 before: Optional[str] = DEFAULT_RUN_LIST_PARAMS[LIST_PARAM_BEFORE]) -> Any:
    ...
    def list_run_steps(self,
                      ...
                      before: Optional[str] = DEFAULT_RUN_STEP_LIST_PARAMS[LIST_PARAM_BEFORE]) -> Any:
