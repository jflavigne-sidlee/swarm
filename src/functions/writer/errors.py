...
ERROR_PATH_NO_READ: Final = "No read permission for path: {path}"
ERROR_PATH_NO_WRITE: Final = "No write permission for path: {path}"
...
ERROR_PERMISSION_DENIED_PATH: Final = "Permission denied for path: {path}"
...
# Lock error messages
ERROR_LOCK_ACQUISITION: Final = "Failed to acquire lock for section '{section}'"
ERROR_LOCK_METADATA: Final = "Error handling lock metadata: {error}"
ERROR_LOCK_CLEANUP: Final = "Failed to clean up lock: {error}"
ERROR_LOCK_RELEASE: Final = "Error releasing lock: {error}"
ERROR_UNEXPECTED_LOCK: Final = "Unexpected error during lock operation: {error}"
ERROR_INVALID_TIMEOUT: Final = "acquire_timeout must be between {min_timeout} and {max_timeout} seconds"
ERROR_INVALID_CLEANUP_AGE: Final = "Cleanup age must be positive"
